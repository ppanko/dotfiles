...
Project-root helpers are provided by =p3-core= and reused by ESS, Python, and
terminal workflows.
...
Windows Rtools/MSYS2 discovery remains near the beginning of this file so Git
and other subprocess-using packages see it during startup.  Shell/vterm
behavior is implemented in =lisp/p3-terminal.el=; the package wiring remains
here.
