...
Citation processing (see [[https://github.com/andras-simonyi/citeproc-el?tab=readme-ov-file#requirements][github]])
...
#+BEGIN_SRC emacs-lisp
  (when (eq system-type 'windows-nt)
    (setq-default inferior-R-program-name "C:\\Program Files\\R\\R-4.3.2\\bin\\x64\\Rterm.exe"))
#+END_SRC
